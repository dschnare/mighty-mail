...
var Row = React.createClass({displayName: "Row",
	...
	render: function () {
		...
		return (
			React.createElement("table", {cellSpacing: "0", cellPadding: "0", border: "0", align: "center", bgColor: this.props.bgColor, width: this.props.width, className: wrapperClassName}, 
				React.createElement("tbody", null, 
					React.createElement("tr", null, 
						React.createElement(RawHtml, {wrapper: "td", align: "center", width: this.props.width, className: cellClassName}, children)
					)
				)
			)
		);
